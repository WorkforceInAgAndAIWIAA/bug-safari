    ...
    <div className="mx-auto max-w-3xl px-4 py-6">
      ...
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2 rounded-xl border border-border bg-card p-3">
        ...
        <div className="flex items-center gap-2">
          <button onClick={endSession} className="rounded-md border border-border bg-card px-3 py-1.5 text-sm hover:bg-muted">
            End session
          </button>
          <button onClick={onExit} className="inline-flex items-center gap-1 rounded-md border border-border bg-card px-3 py-1.5 text-sm hover:bg-muted">
